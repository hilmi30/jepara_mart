...
public class PostOrder {
    ...
    @SerializedName("delivery_kecamatan")
    @Expose
    private String deliveryKecamatan;
    ...
    @SerializedName("billing_kecamatan")
    @Expose
    ...
    public String getDeliveryKecamatan() {
        return deliveryKecamatan;
    }

    public void setDeliveryKecamatan(String deliveryKecamatan) {
        this.deliveryKecamatan = deliveryKecamatan;
    }
