...
//        holder.checkout_item_price_final.setText(ConstantValues.CURRENCY_SYMBOL + cartProduct.getCustomersBasketProduct().getTotalPrice());
        ...
        holder.checkout_item_price.setText(Utilities.convertToRupiah(cartProduct.getCustomersBasketProduct().getProductsPrice()));
        holder.checkout_item_price_final.setText(Utilities.convertToRupiah(cartProduct.getCustomersBasketProduct().getTotalPrice()));
