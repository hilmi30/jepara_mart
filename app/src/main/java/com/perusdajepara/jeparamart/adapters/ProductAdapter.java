...
import com.perusdajepara.jeparamart.models.product_model.ProductDetails;
...
//                holder.product_price_new.setText(ConstantValues.CURRENCY_SYMBOL + product.getDiscountPrice());
                ...
                holder.product_price_old.setText(Utilities.convertToRupiah(product.getProductsPrice()));
                holder.product_price_new.setText(Utilities.convertToRupiah(product.getDiscountPrice()));
