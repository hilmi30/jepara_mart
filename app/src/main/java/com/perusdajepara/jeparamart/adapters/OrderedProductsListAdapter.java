...
//        holder.checkout_item_price_final.setText(ConstantValues.CURRENCY_SYMBOL + product.getFinalPrice());
        holder.checkout_item_price.setText(Utilities.convertToRupiah(product.getProductsPrice()));
        holder.checkout_item_price_final.setText(Utilities.convertToRupiah(product.getFinalPrice()));
