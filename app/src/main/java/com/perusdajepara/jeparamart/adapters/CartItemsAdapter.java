...
import com.perusdajepara.jeparamart.databases.User_Recents_DB;
...
//            holder.cart_item_sub_price.setText(ConstantValues.CURRENCY_SYMBOL + new DecimalFormat("#0.00").format(Double.parseDouble(cartProduct.getCustomersBasketProduct().getTotalPrice())));
            holder.cart_item_base_price.setText(Utilities.convertToRupiah(cartProduct.getCustomersBasketProduct().getProductsPrice()));
            holder.cart_item_sub_price.setText(Utilities.convertToRupiah(cartProduct.getCustomersBasketProduct().getTotalPrice()));
...
//        cartFragment.cart_total_price.setText(context.getString(R.string.total) +" : "+ ConstantValues.CURRENCY_SYMBOL + new DecimalFormat("#0.00").format(finalPrice));
        cartFragment.cart_total_price.setText(context.getString(R.string.total) +" : "+ Utilities.convertToRupiah(String.valueOf(finalPrice)));
    }
